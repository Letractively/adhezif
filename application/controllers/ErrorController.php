...
{
    // Classe reprise de MaitrePylo sur développez.com pour afficher la trace
    private $_exception;
    ...
    public function postDispatch() {
        ...
        $message = sprintf('<hr>DEBUG INFOS :<br /><strong>Exception de type <em>%s</em> <font color="green">%s</font>  envoy&eacute;e dans %s &agrave; la ligne %d </strong> <p>Stack Trace : %s </p><hr>',
